        ...
        <div className="glass rounded-3xl p-8 border dark:border-slate-800 space-y-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-indigo-600 dark:text-indigo-400 font-medium">CSE 69_F @ DIU</p>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
            This Routine Hub was designed specifically for Section 69_F to solve the headache of missing classes or looking up messy PDF files.
          </p>
          <div className="pt-4 border-t dark:border-slate-800">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-4">Tech Stack Used</h4>
            <div className="flex flex-wrap gap-2">
              {['React 18', 'TypeScript', 'Tailwind CSS', 'Lucide Icons', 'Vite'].map(tech => (
        ...
        <div className="space-y-4">
          ...
          <div className="glass rounded-2xl p-6 border dark:border-slate-800 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Drop a mail at 252-15-178@diu.edu.bd for feature requests or bug reports.</p>
            </div>
          </div>
        </div>
      </div>
